...
:NOTE:
The line number fonts also needed to be set to a fixed-pitch so that when they are present, they doesn't start creating wavy lines when aligning the fonts.
:END:
