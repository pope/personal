...
static const MonitorRule monrules[] = {
	...
	*/
	/* defaults */
	{ NULL,       0.55f, 1,      @dpiScale@, &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,   -1,  -1 },
};
...
static const struct xkb_rule_names xkb_rules = {
	...
	.options = "ctrl:nocaps",
	*/
	/* .options = "caps:ctrl_modifier,ctrl:swap_lalt_lctl", */
...
/* commands */
static const char *termcmd[] = { "@uwsm@", "app", "--", "@terminal@", NULL };
static const char *menucmd[] = { "@uwsm@", "app", "--", "@rofi@", "-show", "drun", "-run-command", "@uwsm@ app -- {cmd}", NULL };
