...
let s:keepcpo                = &cpo
let g:loaded_AlignMapsPlugin = "v42d"
set cpo&vim
...
map <silent> <script> <Plug>AM_aunum	<SID>WS:'a,'zs/[-+]\=\d\+\%(\.\d*\)\=/@&@/ge<CR>:'a,'zs/\([-+]\)\=\.@\(\d\)/@\1.\2/ge<CR>:'a,'zs/\([0-9.]\)@\([eE]\)@/\1\2/ge<CR>:'a,'zs/@\s*\(\d\+\)\s*@/@\1#@/ge<CR>:'a,'zs/@\([-+]\=\d\+\)\([eE]\)/@\1#\2/ge<CR>:AlignCtrl wmp0P0r<CR>:'a,'zAlign [.@#]<CR>:'a,'zs/\.\(\s\+\)\(\d\+\)@@/.\2\1@@/ge<CR>:'a,'zs/\.\(\s\+\)\(\d\+\)@\s*$/.\2\1@/ge<CR>:'a,'zs/\.\(\s\+\)\(\d\+\%([eE][-+]\+\d\+\)\=\)/.\2\1/ge<CR>:'a,'zs/@@/  /ge<CR>:'a,'zs/^@//e<CR>:'a,'zs/@\s*$//e<CR>:'a,'zs/#\(\s\+\)\([eE][-+]\=\d\+\)/\2\1 /ge<CR>:'a,'zs/#/ /ge<CR>:'a,'zs/@/ /ge<CR><SID>WE
map <silent> <script> <Plug>AM_aenum	<SID>WS:'a,'zs/[-+]\=\d\+\%(,\d*\)\=/@&@/ge<CR>:'a,'zs/\([-+]\)\=,@\(\d\)/@\1,\2/ge<CR>:'a,'zs/\([0-9,]\)@\([eE]\)@/\1\2/ge<CR>:'a,'zs/@\s*\(\d\+\)\s*@/@\1#@/ge<CR>:'a,'zs/@\([-+]\=\d\+\)\([eE]\)/@\1#\2/ge<CR>:AlignCtrl wmp0P0r<CR>:'a,'zAlign [,@#]<CR>:'a,'zs/,\(\s\+\)\(\d\+\)@@/,\2\1@@/ge<CR>:'a,'zs/,\(\s\+\)\(\d\+\)@\s*$/,\2\1@/ge<CR>:'a,'zs/,\(\s\+\)\(\d\+\%([eE][-+]\+\d\+\)\=\)/,\2\1/ge<CR>:'a,'zs/@@/  /ge<CR>:'a,'zs/^@//e<CR>:'a,'zs/@\s*$//e<CR>:'a,'zs/#\(\s\+\)\([eE][-+]\=\d\+\)/\2\1 /ge<CR>:'a,'zs/#/ /ge<CR>:'a,'zs/@/ /ge<CR><SID>WE
