...
(solarized-theme-set-faces
 ...
 '(font-lock-doc-face (:foreground base01 :italic t))
 '(font-lock-doc-string-face (:foreground base01 :italic t))
 ...
 '(font-lock-warning-face (:foreground red))
  ...
  ;; js2-mode
 '(js2-jsdoc-tag (:italic t :foreground base00))
 '(js2-jsdoc-html-tag-name (:italic t :foreground base00))
 '(js2-jsdoc-html-tag-delimiter (:italic t :foreground base00))
 '(js2-jsdoc-type (:italic t :foreground base00))
 '(js2-jsdoc-value (:italic t :foreground base00))
