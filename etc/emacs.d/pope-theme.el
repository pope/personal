...
(custom-theme-set-faces
 ...
 '(eshell-ls-unreadable ((t (:inherit shadow :slant italic))))
 ...
 '(font-lock-preprocessor-face ((t (:inherit font-lock-builtin-face :foreground "ForestGreen"))))
 '(font-lock-regexp-grouping-backslash ((t (:inherit bold :foreground "LimeGreen"))))
 ...
 '(info-menu-header ((((class color) (min-colors 65535))
                      (:inherit variable-pitch :height 1.2 :slant italic))
                     (t
                      (:weight bold))))
 '(info-title-1 ((((class color) (min-colors 65535))
                  (:inherit variable-pitch :height 1.8 :slant italic))
                 (t
                  (:weight bold))))
 ...
 '(info-title-3 ((((class color) (min-colors 65535))
                  (:inherit variable-pitch :height 1.4 :slant italic))
                 (t
                  (:weight bold))))
 ...
 '(magit-log-head-label-remote ((t (:inherit magit-branch :foreground "green4"))))
 '(magit-log-head-label-tags ((t (:inherit magit-log-tag-label))))
 '(magit-log-sha1 ((t (:weight bold))))
 '(magit-log-tag-label ((t (:inherit magit-branch :foreground "orange1"))))
 ...
 '(org-code ((t (:inherit shadow :foreground "green4"))))
 ...
 '(org-level-3 ((((class color) (min-colors 65535))
                 (:inherit variable-pitch :height 1.3 :slant italic))
                (t
                 (:weight bold))))
 ...
 '(org-level-8 ((((class color) (min-colors 65535))
                ...
                (t
                 (:weight bold))))
 '(org-meta-line ((t (:inherit font-lock-comment-face :foreground "grey56"))))
